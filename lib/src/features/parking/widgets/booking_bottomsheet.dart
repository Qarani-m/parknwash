    ...
    return Column(
      ...
      children: [
        ...
        Text(
            ...
            "Yah have Succesfull booked parking space on lot  slot ID SDJHFS3, scan this QR code at the entrance to access the parking space",
        ...
        SizedBox(
          height: 15.h,
                ...
                Text(
            textAlign: TextAlign.center,
            "Please note that QR is valid only for the next 24hrs",
            style: Theme.of(context)
                .textTheme
                .bodyMedium
                ?.copyWith(fontWeight: FontWeight.w400, fontSize: 15.sp)),
